...
add_files -tb ../vgg_16/accelerator/hw_accelerator.cpp -cflags "-DHW_ONLY -I../vgg_16 -std=c++0x"
...
#Second solution
oopen_solution "solution_noPartitionAndParallel"
set_part {xcvu095-ffvc1517-2-e}
create_clock -period 2.5 -name default
config_compile -name_max_length 30 -pipeline_loops 0 -unsafe_math_optimizations
source "acceleratorNoPartitionAndParallel_directives.tcl"
#csim_design -argv {7} -compiler gcc -setup
csynth_design
#cosim_design
export_design -rtl verilog -format ip_catalog
close_solution
...
create_clock -period 2.5 -name default
config_compile -name_max_length 30 -pipeline_loops 0 -unsafe_math_optimizations
source "acceleratorDataFlow_directives.tcl"
#csim_design -argv {0} -compiler gcc -setup
csynth_design
#cosim_design
export_design -rtl verilog -format ip_catalog
