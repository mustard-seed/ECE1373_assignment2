...
############################################################
set_directive_array_partition -type cyclic -factor 4 -dim 1 "accelerator" bufferOutput
...
set_directive_dataflow "convLayer_Forward/DFLOW"
set_directive_pipeline "convLayer_WrapperLoadWeightsAndInputs"
set_directive_loop_merge "convLayer_Forward/CONVLAYER_FORWARD_FOR_C"
set_directive_dataflow "convLayer_ComputeWrapper/CONVLAYER_FORWARD_FOR_C"
set_directive_array_partition -type cyclic -factor 1 -dim 1 "convLayer_ComputeWrapper" bufferBroadcastA
set_directive_array_partition -type cyclic -factor 4 -dim 2 "convLayer_ComputeWrapper" bufferBroadcastA
set_directive_array_partition -type cyclic -factor 4 -dim 3 "convLayer_ComputeWrapper" bufferBroadcastA
set_directive_array_partition -type complete -dim 0 "convLayer_ComputeWrapper" bufferWeightsA
