...
model  = '/home/jamesliu/ECE1373/ECE1373_assignment2/office_data/VGG_ILSVRC_16_layers_deploy_update.prototxt'
weights  = '/home/jamesliu/ECE1373/ECE1373_assignment2/office_data/VGG_ILSVRC_16_layers_update.caffemodel'
mean_file = '/home/jamesliu/ECE1373/ECE1373_assignment2/office_data/imagenet_mean_224.binaryproto'
image_root = 'data/vgg_batches/'
imagenet_val_path = '/home/jamesliu/ECE1373/ECE1373_assignment2/office_data/ilsvrc12_train_224_lmdb'
...
for key, value in lmdb_cursor:
    ...
    for layer in layers:
        ...
        #dirname = dirnameBatch + string(layer,'/','_')
        dirname = dirnameBatch + layer.replace('/','_')
