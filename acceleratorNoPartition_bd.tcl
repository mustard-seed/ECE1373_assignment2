...
CONFIG.WUSER_WIDTH {0} \
  ...
  set_property -dict [ list \
CONFIG.ASSOCIATED_RESET {rst:Res:aresetn:S00_ARESETN} \
CONFIG.CLK_DOMAIN {static_region_xdma_0_0_axi_aclk} \
CONFIG.FREQ_HZ {250000000} \
 ] $axi_aclk
...
CONFIG.DATA_WIDTH {32} \
  ...
  connect_bd_intf_net -intf_net accelerator_0_m_axi_mem [get_bd_intf_pins accelerator_0/m_axi_mem] [get_bd_intf_pins axi_interconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins accelerator_0/s_axi_CTRL_BUS] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net pcl_axifull_bridge_0_m_axi [get_bd_intf_ports m_axi] [get_bd_intf_pins pcl_axifull_bridge_0/m_axi]
  connect_bd_intf_net -intf_net pcl_axilite_bridge_0_m_axi [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins pcl_axilite_bridge_0/m_axi]
  connect_bd_intf_net -intf_net s_axi_1 [get_bd_intf_ports s_axi] [get_bd_intf_pins pcl_axilite_bridge_0/s_axi]

  # Create port connections
  connect_bd_net -net S00_ARESETN_1 [get_bd_ports S00_ARESETN] [get_bd_pins accelerator_0/ap_rst_n] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins pcl_axifull_bridge_0/aresetn] [get_bd_pins pcl_axilite_bridge_0/aresetn] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  ...
  create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces accelerator_0/Data_m_axi_mem] [get_bd_addr_segs m_axi/Reg] SEG_m_axi_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces s_axi] [get_bd_addr_segs accelerator_0/s_axi_CTRL_BUS/Reg] SEG_accelerator_0_Reg
