...
add_files -tb ../vgg_16/accelerator/test/accelerator_test.cpp -cflags "-I../vgg_16 -std=c++0x"
add_files -tb ../vgg_16/accelerator/accelerator.cpp -cflags "-I../vgg_16 -std=c++0x"
open_solution "solution_partitionAndParallel"
set_part {xcvu095-ffvc1517-2-e}
create_clock -period 5 -name default
source "./accelerator/solution_partitionAndParallel/directives.tcl"
