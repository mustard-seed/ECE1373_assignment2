...
set projName acceleratorDummy_pr
...
set_property  ip_repo_paths  {8v3_shell/ocl_ips hls_proj/acceleratorDummy/solution_partitionAndParallel/impl/ip} [current_project]
update_ip_catalog

#source pr_region_2_bd.tcl
#source 8v3_shell/nn_bd.tcl
source acceleratorDummy_bd.tcl
