...
set projName acceleratorFlow_pr
...
set_property  ip_repo_paths  {8v3_shell/ocl_ips hls_proj/accelerator/solution_dataFlow/impl/ip} [current_project]
update_ip_catalog

#source pr_region_2_bd.tcl
#source 8v3_shell/nn_bd.tcl
source acceleratorFlow_bd.tcl
