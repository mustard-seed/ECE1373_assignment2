...
set projName acceleratorNoPartition_pr
...
set_property  ip_repo_paths  {8v3_shell/ocl_ips hls_proj/accelerator/solution_noPartitionAndParallel/impl/ip} [current_project]
update_ip_catalog

#source pr_region_2_bd.tcl
#source 8v3_shell/nn_bd.tcl
source acceleratorNoPartition_bd.tcl
